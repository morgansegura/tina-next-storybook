// [Styles]
import * as s from "@components/elements/icons/social/tiktok/tiktok.styled";
// [Types]
import { ITiktok } from "@components/elements/icons/social/tiktok/tiktok.types";

export default function TiktokIcon({ fill, height, width, viewBox }: ITiktok) {
    return (
        <s.IconSvg
            width={width}
            height={height}
